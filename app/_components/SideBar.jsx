    ...
    return (
        <div className='hidden lg:block fixed left-0 z-10 ' >
            ...
            <div className="flex h-screen  flex-col justify-between ">
                <div className=" py-6">
                    <div className='flex gap-3 border-b border-cr-gray border-opacity-30 pb-4  px-4'>
                        <img src="/bananalogo.png" alt="" />
                        <h1 className='font-medium text-2xl'>ApeStore</h1>
                    </div>
                    <ul className=" space-y-1 px-4">
                        <li className='flex flex-row items-center gap-3'>
                            ...
                            <a
                                href="#"
                                className="  px-4 py-2 text-md font-medium text-cr-gray hover:text-white"
                            >
                                New Pairs
                            </a>
                ...
                <div className="px-4 py-6 mb-[4rem]">
                    <button className=' w-full mb-3 flex gap-3 p-5 justify-center  bg-cr-dark-black-main rounded-3xl shadow-md border border-violet-500/100 '>
                    ...
                    <div className='mt-3 flex gap-3 p-1.5 justify-center border border-cr-orange-main bg-cr-orange rounded-lg '>
                        <h1>icon</h1>
                        <h1>Tutorial</h1>
                    </div>
                    <div className=''>
